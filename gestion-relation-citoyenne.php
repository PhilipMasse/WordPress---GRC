...
require_once GRC_PLUGIN_DIR . 'includes/class-grc-static-map.php';
require_once GRC_PLUGIN_DIR . 'includes/class-grc-pdf-signalement.php';
require_once GRC_PLUGIN_DIR . 'includes/class-grc-captcha.php';
require_once GRC_PLUGIN_DIR . 'includes/class-grc-totp.php';
require_once GRC_PLUGIN_DIR . 'includes/class-grc-roles.php';
require_once GRC_PLUGIN_DIR . 'includes/class-grc-agent-2fa.php';
...
require_once GRC_PLUGIN_DIR . 'admin/class-grc-admin-modeles.php';
require_once GRC_PLUGIN_DIR . 'admin/class-grc-admin-recherche.php';
require_once GRC_PLUGIN_DIR . 'admin/class-grc-admin-export-import.php';
